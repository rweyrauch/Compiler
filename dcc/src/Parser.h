// Generated by Bisonc++ V6.08.00 on Sat, 19 Jul 2025 08:11:24 -0700
    ...
    public:
            ...
            m_enableBasicBlocksOutput(false)
       {
        ...
        std::vector<IrTacStmt> optimize(const std::vector<IrTacStmt>& statements)
        {
            ...
            m_optimizations.erase(std::unique(m_optimizations.begin(), m_optimizations.end()), m_optimizations.end());
